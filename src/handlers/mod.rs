...
pub async fn create_question(
    ...
    let call = handlers_inner::create_question(question.0, questions_dao).await;
    match call {
        Ok(q) => Ok(Json(q)),
...
pub async fn read_questions(
    ...
    let call = handlers_inner::read_questions(questions_dao.inner()).await;
    match call {
        Ok(q) => Ok(Json(q)),
        Err(err) => Err(err.into())
    }
...
pub async fn delete_question(
    ...
    let call = handlers_inner::delete_question(question_uuid.0, questions_dao).await;
    match call {
        Ok(_) => Ok(()),
        Err(err) => Err(err.into())
    }
...
pub async fn create_answer(
    ...
    let call = handlers_inner::create_answer(answer.0, answers_dao).await;
    match call {
        Ok(a) => Ok(Json(a)),
        Err(err) => Err(err.into())
    }
...
pub async fn read_answers(
    ...
    let call = handlers_inner::read_answers(question_uuid.0, answers_dao).await;
    match call {
        Ok(a) => Ok(Json(a)),
        Err(err) => Err(err.into())
    }
...
pub async fn delete_answer(
    ...
    let call = handlers_inner::delete_answer(answer_uuid.0, answers_dao).await;
    match call {
        Ok(_) => Ok(()),
        Err(err) => Err(err.into())
    }
